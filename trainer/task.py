...
parser.add_argument('--dataset_A_dir', dest='dataset_A_dir', default='../MIDI/Classic/Classic_test/phrase_test', help='path of the dataset of domain A')
parser.add_argument('--dataset_B_dir', dest='dataset_B_dir', default='../MIDI/Jazz/Jazz_test/phrase_test', help='path of the dataset of domain B')
...
parser.add_argument('--job-dir', dest='job_dir', default='./job', help='models are saved here')
...
def main(_):
    if not file_io.file_exists(args.job_dir):
        file_io.create_dir(args.job_dir)
