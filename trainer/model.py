...
class cyclegan(object):
    ...
    def train(self, args):
        ...
        log_dir = '{}{}2{}_{}_{}_{}'.format(self.log_dir, "Classic", "Jazz", self.now_datetime,
        ...
        for epoch in range(args.epoch):
            ...
            for idx in range(0, batch_idxs):
                ...
                if np.mod(counter, args.print_freq) == 1:
                    sample_dir = os.path.join(self.sample_dir, '{}2{}_{}_{}_{}'.format("Classic",
                                                                                       "Jazz",
                                                                                       self.now_datetime,
                                                                                       self.model,
                                                                                       self.sigma_d))
                ...
                if np.mod(counter, batch_idxs) == 1:
                    ...
                    self.save(args.job_dir, counter)

    def save(self, checkpoint_dir, step):
        model_name = "cyclegan.model"
        model_dir = "{}2{}_{}_{}_{}".format("Classic", "Jazz", self.now_datetime, self.model,
                                            self.sigma_d)
    ...
    def test(self, args):
        ...
        test_dir_mid = os.path.join(args.test_dir, '{}2{}_{}_{}_{}/{}/mid'.format("Classic",
                                                                                  "Jazz",
                                                                                  self.now_datetime,
                                                                                  self.model,
                                                                                  self.sigma_d,
        ...
        test_dir_npy = os.path.join(args.test_dir, '{}2{}_{}_{}_{}/{}/npy'.format("Classic",
                                                                                  "Jazz",
                                                                                  self.now_datetime,
                                                                                  self.model,
                                                                                  self.sigma_d,
